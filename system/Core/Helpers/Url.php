<?php
    ...
    class Url
    {
        ...
        {
            $url = ($fullpath === false) ? viewRoot() . $url : $url;
        ...
        public static function redirectTo($url, $code = 301)
        {
            header('Location: ' . getenv("SITE_URL") . $url, true, $code);
        }
        ...
        {
            return getenv('SITE_URL') . sprintf("/assets/%s", $module);
        }
